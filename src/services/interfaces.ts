 ...
 */
import type { Festival, UserPreferences, Recommendation, FestivalDiscoveryResponse, UserFeedback, CalendarEvent } from '@/types';
...
export interface IFestivalDiscoveryService {
     ...
     */
    discoverArtists(festivalId: string, userPreferences: UserPreferences): Promise<FestivalDiscoveryResponse>;
     ...
     * @returns Promise resolving to discovery response with recommendations
     */
    discoverArtistsFromUrl(festivalUrl: string, userPreferences: UserPreferences): Promise<FestivalDiscoveryResponse>;
     ...
     */
    refineRecommendations(sessionId: string, userPreferences: UserPreferences): Promise<Recommendation[]>;
}
...
export interface IRecommendationService {
     ...
     */
    calculateArtistScore(userPreferences: UserPreferences, artistId: string): Promise<number>;
