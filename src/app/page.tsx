    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Enter a festival URL and your music preferences to get personalized artist recommendations. 
      ...
      {discoveryResponse && !isLoading && (
        <div className="animate-fade-in">
          <RecommendationsList
            festival={discoveryResponse.festival}
            recommendations={discoveryResponse.recommendations}
      ...
      {!discoveryResponse && !isLoading && !error && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">
            Enter a festival URL above to get started with personalized recommendations.
          </p>
        </div>
      )}
    </div>
