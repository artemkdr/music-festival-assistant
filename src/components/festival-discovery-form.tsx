 ...
 */
export function FestivalDiscoveryForm({ 
  onSubmit, 
  isLoading 
}: FestivalDiscoveryFormProps): ReactElement {
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          />
          {errors.festivalUrl && (
            <p className="mt-1 text-sm text-red-600">{errors.festivalUrl}</p>
          )}
          <p className="mt-1 text-sm text-gray-500">
            For this demo, any URL will work as we're using mock data
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-500">
            Select genres you enjoy ({selectedGenres.length} selected)
          </p>
        </div>
