    ...
    return (
        <div className="flex flex-col items-center justify-center space-y-4 min-h-[200px]">
            ...
            <div className="text-center space-y-2 max-w-md">
                ...
                {elapsedTime >= 5 && <p className="text-gray-500 text-sm">Elapsed time: {elapsedTime}s</p>}

                {/* Show patience message after 30 seconds */}
                {elapsedTime >= 30 && <p className="text-orange-600 text-sm font-medium animate-pulse">Thank you for your patience! We&apos;re working hard to find the perfect festivals for you.</p>}
            </div>
        </div>
    );
}
